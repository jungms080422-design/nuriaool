...
with tabs[0]:
    ...
    questions = [
        {"q": "파티에서 난", "a":"사람들과 활발히 얘기하며 에너지 얻음 (E)", "b":"한두 명이랑 깊게 얘기하는 걸 선호함 (I)", "trait":"EI"},
        {"q": "결정할 때", "a":"직관/감으로 즉흥적인 편 (P)", "b":"계획 세우고 체크하는 편 (J)", "trait":"JP"},
        {"q": "정보를 볼 때", "a":"사실과 세부 사항에 주목 (S)", "b":"패턴과 미래 가능성에 주목 (N)", "trait":"SN"},
        {"q": "토론할 때", "a":"논리와 근거로 말하는 편 (T)", "b":"사람 감정과 조화를 고려 (F)", "trait":"TF"},
        {"q": "여가시간엔", "a":"계획된 활동으로 효율적으로 보냄 (J)", "b":"그날 기분 따라 자유롭게 보냄 (P)", "trait":"JP"},
        {"q": "친구가 고민상담할 때", "a":"직설적으로 해결책 제시 (T)", "b":"공감과 감정 지지 먼저 (F)", "trait":"TF"},
        {"q": "일을 할 때", "a":"체계적으로 하나씩 처리 (J)", "b":"여러 가능성 열어두고 진행 (P)", "trait":"JP"},
        {"q": "학습 스타일", "a":"구체적 사례와 연습으로 익힘 (S)", "b":"개념과 원리 중심으로 이해 (N)", "trait":"SN"},
        {"q": "새로운 사람 만나면", "a":"바로 말 걸고 친해지려 함 (E)", "b":"관찰 후 천천히 다가감 (I)", "trait":"EI"},
        {"q": "결정 내릴 때", "a":"객관적 분석으로 선택 (T)", "b":"가치와 감정 고려해 선택 (F)", "trait":"TF"},
    ]
